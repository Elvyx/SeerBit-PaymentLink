...
public class signUp {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		try {
		// Check if the accept cookies button is displayed
		if (acceptCookies.isDisplayed()) {
		    ...
		    System.out.println("No cookies banner found. Continue with the normal flow.");
		}
		
		
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement countrySelection=wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='basic-single css-2b097c-container']")));
		...
		businessName.sendKeys("Tee3's place");
		...
		email.sendKeys("t3bd@yopmail.com");
