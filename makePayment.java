...
public class makePayment {
	...
	public static void main(String[] args) {
		...
		WebElement payoutIframe=wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".seerbit-ffraom")));
		 driver.switchTo().frame(payoutIframe);
		//WebElement authField=wait.until(ExpectedConditions.presenceOfElementLocated(By.id("popcorn")));
		//authField.click();
		
		//String authentication = "Authentication Successful";
		//WebElement authInput = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("span[class='ml-3 block truncate']")));
		//authInput.sendKeys(authentication);
		//authInput.sendKeys(Keys.ENTER);
